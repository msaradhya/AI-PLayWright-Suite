/**
 * Hoonuit Attendance Data Validation Teacher User Test
 * Validates attendance data in Hoonuit dashboards as a teacher user
 * Converted from Java: psqa.integration.hoonuit_sis.uitest.validation.HoonuitAttendanceDataValidationTeacherUserTest
 *
...
// Test suite for Attendance Data Validation as Teacher User
describe('Hoonuit Attendance Data Validation - Teacher User @TCM-65393', () => {
    ...
    /**
     * Verify Attendance Data in Hoonuit as Teacher
     * Tests the attendance data validation for teacher user by:
     * 1. Logging in as ETL Teacher user
     ...
     */
    test('TCM-65393', 'Verify Attendance Data In Hoonuit As Teacher', async ({ page }) => {
        // Login as ETL Teacher user
        await HoonuitHelper.loginToHoonuitAsTeacher(page, HoonuitIntegrationUsers.etlTeacher_User2);
        ...
        // Apply filters: School and Staff (using teacher-specific filter values)
        const filters = HoonuitAttendanceDataValidationData.getTeacherUserFilters();
        ...
        await step('Validate Student Absences/Tardies Table for 2nd Semester', async () => {
            ...
            expect(
                lateValue,
                `Incorrect P1 - AP German I Late Value for 2nd Sem. in Who are my students with absences or tardies Table`
