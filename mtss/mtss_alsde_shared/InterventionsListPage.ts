...
export class InterventionsListPage extends BasePage {
    ...
    constructor(page: Page) {
        super(page);
        this.pageHeading = page.locator('h1').filter({ hasText: /Intervention List/i });
    ...
    /**
     * Wait for the Interventions List page to load completely
    ...
    /**
     * Validate that the Interventions List Dashboard is loaded properly
     */
    async validateDashboard(): Promise<void> {
        ...
        // Verify dashboard content is present (main container)
    ...
    async validateAllMetrics(timeout: number = 180000): Promise<void> {
        console.log('🔍 Starting metrics validation for Interventions List...');
        ...
        console.log('✅ All metrics validation completed successfully for Interventions List');
    }
