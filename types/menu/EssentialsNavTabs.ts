/**
 * Enum representing Essentials Navigation Tabs
 * Maps directly to Java enum psqa.hoonuit.shared.enums.menu.EssentialsNavTabs
 ...
 */
export interface EssentialsNavTabInfo {
    readonly value: string;
    readonly listIndex: number;
    readonly key: keyof typeof EssentialsNavTabs;
}

/**
 * Class providing utility methods for EssentialsNavTabs
 ...
 */
export class EssentialsNavTabsUtils {
    
    private static readonly tabInfoMap: ReadonlyMap<EssentialsNavTabs, EssentialsNavTabInfo> = new Map([
        [EssentialsNavTabs.ENROLLMENT, { value: "Enrollment", listIndex: 0, key: "ENROLLMENT" }],
        [EssentialsNavTabs.ATTENDANCE, { value: "Attendance", listIndex: 1, key: "ATTENDANCE" }],
        [EssentialsNavTabs.BEHAVIOR, { value: "Behavior", listIndex: 2, key: "BEHAVIOR" }],
        [EssentialsNavTabs.ACADEMICS, { value: "Academics", listIndex: 3, key: "ACADEMICS" }],
        [EssentialsNavTabs.ASSESSMENTS, { value: "Assessments", listIndex: 4, key: "ASSESSMENTS" }],
        [EssentialsNavTabs.DIGITAL_LEARNING, { value: "Digital Learning", listIndex: 5, key: "DIGITAL_LEARNING" }],
        [EssentialsNavTabs.STUDENTS, { value: "Students", listIndex: 6, key: "STUDENTS" }],
        [EssentialsNavTabs.REPORTING, { value: "Reporting", listIndex: 7, key: "REPORTING" }]
    ]);

    private static readonly indexToTabMap: ReadonlyMap<number, EssentialsNavTabs> = new Map([
        [0, EssentialsNavTabs.ENROLLMENT],
        [1, EssentialsNavTabs.ATTENDANCE],
        [2, EssentialsNavTabs.BEHAVIOR],
        [3, EssentialsNavTabs.ACADEMICS],
        [4, EssentialsNavTabs.ASSESSMENTS],
        [5, EssentialsNavTabs.DIGITAL_LEARNING],
        [6, EssentialsNavTabs.STUDENTS],
        [7, EssentialsNavTabs.REPORTING]
    ]);
     ...
     */
    static getValue(tab: EssentialsNavTabs): string {
     ...
     */
    static getListIndex(tab: EssentialsNavTabs): number {
        const tabInfo = this.tabInfoMap.get(tab);
        if (!tabInfo) {
            throw new Error(`Invalid tab: ${tab}`);
        }
     ...
     */
    static getTabInfo(tab: EssentialsNavTabs): EssentialsNavTabInfo {
        const tabInfo = this.tabInfoMap.get(tab);
        if (!tabInfo) {
            throw new Error(`Invalid tab: ${tab}`);
        }
     ...
     */
    static getAllTabs(): EssentialsNavTabs[] {
        return Object.values(EssentialsNavTabs);
    }
     ...
     */
    static getAllTabInfos(): EssentialsNavTabInfo[] {
     ...
     */
    static getTabByIndex(index: number): EssentialsNavTabs | undefined {
     ...
     * @returns The navigation tab enum or undefined if not found
     */
    static getTabByValue(value: string): EssentialsNavTabs | undefined {
    ...
    /**
     * Validate if a string is a valid EssentialsNavTabs value
    ...
    static isValidTab(value: string): boolean {
        return Object.values(EssentialsNavTabs).includes(value as EssentialsNavTabs);
    }
     ...
     */
    static getTabsInOrder(): EssentialsNavTabs[] {
        const tabs: EssentialsNavTabs[] = [];
     ...
     * @returns CSS selector string
     */
    static getTabSelector(tab: EssentialsNavTabs): string {
     ...
     */
    static toSelector(tab: EssentialsNavTabs): string {
     ...
     */
    static toCssClass(tab: EssentialsNavTabs): string {
     ...
     */
    static getDisplayName(tab: EssentialsNavTabs): string {
     ...
     */
    static isFirstTab(tab: EssentialsNavTabs): boolean {
     ...
     */
    static isLastTab(tab: EssentialsNavTabs): boolean {
     ...
     */
    static getNextTab(currentTab: EssentialsNavTabs): EssentialsNavTabs | undefined {
     ...
     */
    static getPreviousTab(currentTab: EssentialsNavTabs): EssentialsNavTabs | undefined {
        const currentIndex = this.getListIndex(currentTab);
        return this.getTabByIndex(currentIndex - 1);
    }
}