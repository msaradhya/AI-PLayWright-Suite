/**
 * Enum representing My Students Navigation Tabs
 ...
 */
export interface MyStudentsNavTabInfo {
    readonly value: string;
    readonly listIndex: number;
    readonly key: keyof typeof MyStudentsNavTabs;
}

/**
 * Class providing utility methods for MyStudentsNavTabs
 * Enhanced for Playwright test automation support
 */
export class MyStudentsNavTabsUtils {
    
    private static readonly tabInfoMap: ReadonlyMap<MyStudentsNavTabs, MyStudentsNavTabInfo> = new Map([
        [MyStudentsNavTabs.OVERVIEW, { value: 'Student Overview', listIndex: 0, key: 'OVERVIEW' }],
        [MyStudentsNavTabs.ABSENCES, { value: 'Absences', listIndex: 1, key: 'ABSENCES' }]
    ]);

    private static readonly indexToTabMap: ReadonlyMap<number, MyStudentsNavTabs> = new Map([
        [0, MyStudentsNavTabs.OVERVIEW],
        [1, MyStudentsNavTabs.ABSENCES]
    ]);
     ...
     */
    static getValue(tab: MyStudentsNavTabs): string {
     ...
     */
    static getListIndex(tab: MyStudentsNavTabs): number {
        const tabInfo = this.tabInfoMap.get(tab);
        if (!tabInfo) {
            throw new Error(`Invalid tab: ${tab}`);
        }
     ...
     */
    static getTabInfo(tab: MyStudentsNavTabs): MyStudentsNavTabInfo {
        const tabInfo = this.tabInfoMap.get(tab);
        if (!tabInfo) {
            throw new Error(`Invalid tab: ${tab}`);
        }
     ...
     */
    static getAllTabs(): MyStudentsNavTabs[] {
        return Object.values(MyStudentsNavTabs);
    }
     ...
     */
    static getAllTabInfos(): MyStudentsNavTabInfo[] {
     ...
     */
    static getTabByIndex(index: number): MyStudentsNavTabs | undefined {
     ...
     * @returns The navigation tab enum or undefined if not found
     */
    static getTabByValue(value: string): MyStudentsNavTabs | undefined {
     ...
     * @returns CSS selector string
     */
    static getTabSelector(tab: MyStudentsNavTabs): string {
     ...
     */
    static getNextTab(currentTab: MyStudentsNavTabs): MyStudentsNavTabs | undefined {
     ...
     */
    static getPreviousTab(currentTab: MyStudentsNavTabs): MyStudentsNavTabs | undefined {
        const currentIndex = this.getListIndex(currentTab);
        return this.getTabByIndex(currentIndex - 1);
    }
}